...
class Animal
{
		public:
				...
				//with this strange syntax we define an unimplemented "interface" function
...
// We can now use Animal as the genera type
...
void animal_sound(Animal &a)
{
		...
		// type information is still there, we can extrace the original type by
...
{
		a.make_sound();
		// howerver, we can't easily access type information here without
		// using specialization..
}

// ..and that's pretty much equicalent to overloading the function
